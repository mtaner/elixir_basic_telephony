defmodule ConsultantLegRequestedHandler do
  use Commanded.Event.Handler, name: "ConsultantLegRequestedHandler"

  def handle(%ConsultantLegRequested{conference_key: conference_key, to: to}, _metadata) do
